...
class MealsListView extends StatefulWidget {
  MealsListView(
      {Key? key, this.mainScreenAnimationController, this.mainScreenAnimation, required this.mealsData})
      : super(key: key);
...
class _MealsListViewState extends State<MealsListView>
  ...
  MealsListData _groupByList(MealType type){
    late MealsListData data = MealsListData(titleTxt: type, meals: []);
    widget.mealsData
  ...
  void initState() {
    ...
    mealsListData = [];
    MealType.values.forEach((element) { mealsListData.add(_groupByList(element));});
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            mealsListData?.kcal != 0
                              ...
                              children: <Widget>[
                                Text(
                                  mealsListData!.kcal.toString().split(".")[0],
                                  textAlign: TextAlign.center,
                                  style: const TextStyle(
                                    fontFamily: FitnessAppTheme.fontName,
                                    fontWeight: FontWeight.w500,
